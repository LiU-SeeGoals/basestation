...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_RED_Pin|MOTOR1_REVERSE_Pin|NRF_CSN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KICKER_DISCHARGE_Pin LED_RED_Pin MOTOR1_REVERSE_Pin NRF_CSN_Pin */
  GPIO_InitStruct.Pin = KICKER_DISCHARGE_Pin|LED_RED_Pin|MOTOR1_REVERSE_Pin|NRF_CSN_Pin;
